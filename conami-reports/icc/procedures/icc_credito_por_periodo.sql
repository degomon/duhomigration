...
-- select * from icc_credito where cantidad_cuotas > 0
CREATE OR REPLACE FUNCTION icc_credito_por_periodo(period_id numeric)
  RETURNS void
  AS $$
DECLARE
  car RECORD;
...
(
          ...
          0, --25 id_sindicado
          2, --26 id_situacion_credito
          0, --27 id_tipo_agrupacion_credito
          ...
          car.montototal, --38 mto_original
